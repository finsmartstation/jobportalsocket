...
async function saveImageMessage(current_datetime,user_id,receiver_id,room,room_type,message,message_type,optional_text,delivered_status,read_status,message_data,message_id){
    const result=await db.sequelize.query("INSERT INTO `chat_list`(`created_datetime`, `senter_id`, `receiver_id`, `room`, `room_type`, `replay_id`, `message`, `message_type`, `optional_text`, `delivered_status`, `read_status`, `message_data`) VALUES ('"+current_datetime+"','"+user_id+"','"+receiver_id+"','"+room+"','"+room_type+"','"+message_id+"','"+message+"','"+message_type+"','"+optional_text+"','"+delivered_status+"','"+read_status+"','"+message_data+"')");
    return result[0];
}

async function saveDocMessage(current_datetime,user_id,receiver_id,room,room_type,message,message_type,optional_text,thumbnail,delivered_status,read_status,message_data,message_id){
    const result=await db.sequelize.query("INSERT INTO `chat_list`(`created_datetime`, `senter_id`, `receiver_id`, `room`, `room_type`, `replay_id`, `message`, `message_type`, `optional_text`, `thumbnail`, `delivered_status`, `read_status`, `message_data`) VALUES ('"+current_datetime+"','"+user_id+"','"+receiver_id+"','"+room+"','"+room_type+"','"+message_id+"','"+message+"','"+message_type+"','"+optional_text+"','"+thumbnail+"','"+delivered_status+"','"+read_status+"','"+message_data+"')");
    return result[0];
}

async function saveVideoMessage(current_datetime,user_id,receiver_id,room,room_type,message,message_type,optional_text,thumbnail,duration,delivered_status,read_status,message_data,message_id){
    const result=await db.sequelize.query("INSERT INTO `chat_list`(`created_datetime`, `senter_id`, `receiver_id`, `room`, `room_type`, `replay_id`, `message`, `message_type`, `optional_text`, `thumbnail`, `duration`,`delivered_status`, `read_status`, `message_data`) VALUES ('"+current_datetime+"','"+user_id+"','"+receiver_id+"','"+room+"','"+room_type+"','"+message_id+"','"+message+"','"+message_type+"','"+optional_text+"','"+thumbnail+"','"+duration+"','"+delivered_status+"','"+read_status+"','"+message_data+"')");
    return result[0];
}

async function saveVoiceMessage(current_datetime,user_id,receiver_id,room,room_type,message,message_type,optional_text,thumbnail,duration,delivered_status,read_status,message_data,message_id){
    const result=await db.sequelize.query("INSERT INTO `chat_list`(`created_datetime`, `senter_id`, `receiver_id`, `room`, `room_type`, `replay_id`, `message`, `message_type`, `optional_text`, `thumbnail`, `duration`,`delivered_status`, `read_status`, `message_data`) VALUES ('"+current_datetime+"','"+user_id+"','"+receiver_id+"','"+room+"','"+room_type+"','"+message_id+"','"+message+"','"+message_type+"','"+optional_text+"','"+thumbnail+"','"+duration+"','"+delivered_status+"','"+read_status+"','"+message_data+"')");
    return result[0];
}
